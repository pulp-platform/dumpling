...
class PULPJTagTapRosetta(PULPJtagTap):
    ...
    def set_config_reg(
        ...
        soc_fll_bypass_en: bool,
        per_fll_bypass_en: bool,
        blade_disable: bool,
        edram_disable: bool,
        hd_mem_backend_use_edram: bool,
    ) -> List[NormalVector]:
        ...
        return self.driver.write_reg(
            self, self.reg_soc_confreg, id_value, "Program config reg."
        )
    ...
    def verify_config_reg(
        ...
        id_value += "1" if soc_fll_bypass_en else "0"
        id_value += soc_jtag_reg_value.bin
        return self.driver.read_reg(
            self, self.reg_soc_confreg, 13, id_value, "Verify config reg."
        )
